-- Chefs interact with the food directly too -- give Chef the same menu
-- upload/parse capability as Server and Bartender. Fix existing orgs...
update department_meta set has_menu = true where department = 'Chef';

-- ...and re-seed create_organization() so every new org gets it too.
