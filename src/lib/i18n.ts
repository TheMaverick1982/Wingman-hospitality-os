...
const STRINGS: Record<string, Entry> = {
  ...
  "checklist.hub.title": { en: "Your checklists", es: "Tus listas" },
  "checklist.hub.progress": { en: "{done} of {total} done today", es: "{done} de {total} listas hoy" },
  "checklist.hub.itemCount": { en: "{count} items · tap to complete", es: "{count} puntos · toca para completar" },
