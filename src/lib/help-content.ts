...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "note", text: "Assigning a test to an employee (or sending it to all staff), taking it day by day with automatic scoring, retakes and manual unlock, and a board of who passed and who hasn't are rolling out next — this release is the builder and the settings." },
    ],
