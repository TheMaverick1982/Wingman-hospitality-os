...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "list", items: [
        "Each application has a status — New, Reviewed, or Rejected — plus their resume if they attached one. Rejected applications move to an \"Archive\" tab (out of your main list) that you click to see; when you reject someone you can add a private note on why and flag \"Do not hire\" so they're never reconsidered. Filter the active pipeline by status, by job role, or by source.",
