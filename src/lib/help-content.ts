...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "p", text: "The menu stays short on purpose. The sections you use most sit right at the top — Dashboard, Guests, Hiring, Training & Standards, Accountability, Staff, and Culture. Everything else lives under a single \"More\" heading; click it to expand the rest (Shift, Manager channel, Questions, Revenue Growth Planner, Menu Engineering, Standout Audit, Partners, and Reporting). Wingman remembers whether you keep More open, and it opens automatically whenever you're on one of those pages." },
      { kind: "list", items: [
        ...
        "More — everything else: shift board, manager channel, staff questions, growth & menu numbers, the Standout Audit, Partners, and Reporting (which also holds your Hospitality Score).",
