...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    categoryId: "team",
    keywords: ["guest journey", "journey", "stages", "guest experience", "arrival", "greet", "the ask", "touchpoints", "moments", "script", "standard", "map"],
    body: [
      ...
      { kind: "note", text: "Generating or regenerating replaces the current stages, so edit in place once it's close. Managers and owners can edit; staff can view." },
    ],
