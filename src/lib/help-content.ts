...
export const ARTICLES: HelpArticle[] = [
  {
    ...
    body: [
      ...
      { kind: "tip", text: "Managers: keep an eye on Team → Questions. Answering there once, with \"Save to Team Playbook\" checked, means you never have to answer that question again — the assistant will." },
