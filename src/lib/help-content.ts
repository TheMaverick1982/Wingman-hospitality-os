...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "p", text: "The menu stays short on purpose. The sections you use most sit right at the top — Dashboard, Guest Bounce Back, Hiring, Training & Standards, Accountability, Staff, and Culture. Everything else lives under a single \"More\" heading; click it to expand the rest (Guest Reviews, Service Recovery, Guest Journey, Shift, Manager channel, Questions, Revenue Growth Planner, Menu Engineering, Standout Audit, Partners, and Reporting). Wingman remembers whether you keep More open, and it opens automatically whenever you're on one of those pages." },
      { kind: "list", items: [
        "Dashboard — your at-a-glance health: repeat rate, retention, what needs attention.",
        "Guest Bounce Back — log guests and their return visits, and work your win-back list.",
        ...
        "More — everything else: guest reviews & recovery, the guest journey, shift board, manager channel, staff questions, growth & menu numbers, the Standout Audit, Partners, and Reporting (which also holds your Hospitality Score).",
