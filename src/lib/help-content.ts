...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "p", text: "The menu stays short on purpose. The sections you use most sit right at the top — Dashboard, Guests, Hiring, Training & Standards, Accountability, Staff, and Culture. Everything else lives under a single \"More\" heading; click it to expand the rest (Shift, Manager updates, Questions, Revenue Growth Planner, Menu Engineering, Experience Audit, Partners, and Reporting). Wingman remembers whether you keep More open, and it opens automatically whenever you're on one of those pages." },
      { kind: "list", items: [
        "Dashboard — your at-a-glance health: repeat rate, retention, what needs attention.",
        "Guests — everything guest-facing in one place, with tabs across the top: Bounce Back (log guests and work your win-back list), Reviews, Service Recovery, and Guest Journey.",
        "Hiring — applications, interviews, job openings, and your careers page.",
        "Training & Standards — role training, tests, and sign-offs.",
        "Accountability — checklists, spot-checks, and coaching flags.",
        "Staff — your roster and each person's record.",
        "Culture — your Owner's Mindset, values, weekly focus, and team wins.",
        "More — everything else: shift board, manager updates, staff questions, growth & menu numbers, the Experience Audit, Partners, and Reporting (which also holds your Hospitality Score).",
        "Settings — team & permissions, account, and billing (owners and managers).",
      ] },
      { kind: "tip", text: "What you see depends on your role. Owners see everything; managers see most things; staff see the areas relevant to their shift — and anything with nothing in it for your role simply doesn't appear." },
    ],
    links: [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "Buzz the team's phones (optional)" },
      { kind: "p", text: "Wingman can send a phone notification to everyone on the team who has the app installed when a win or shout-out is posted (including a guest review a manager turns into a shout-out), and when a manager sets this week's pre-shift focus or weekly experiment — so recognition is felt in the moment and everyone starts the week pointed at the same thing." },
      { kind: "note", text: "These team-wide pushes are OFF by default (so no one is buzzed until you decide). To turn them on, an owner opens Settings → Notifications → Culture and switches on \"Wins & recognition (push to the team)\" and/or \"Weekly focus & experiment (push to the team).\" Only people who've installed the app and allowed notifications ever receive them." },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "Company-wide and per-location" },
      { kind: "p", text: "If you run more than one location, the Hospitality Score works at two levels, driven by the location switcher at the top of the page. On \"All locations\" you take and track the company-wide score — the owner's read on the overall culture. Switch to a single location and you get that location's own score and trend, tracked separately. The owner can take the company-wide one and any location's; a location's manager can take their own location's. It's the perfect way to see which location's culture is strongest and which needs attention." },
      { kind: "h", text: "Tracking it over time" },
      { kind: "p", text: "Every assessment is saved (per scope), so once you've taken it more than once you get a trend chart and a \"+N since last time\" on your latest score. Retake it every quarter (or after a big training push) to prove the culture is actually moving, not just that you hoped it would. Managers can view the score and history; the owner records the company-wide one and a location's manager can record theirs." },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "Turn the \"who served you?\" question on or off" },
      { kind: "p", text: "By default the survey asks \"Who took care of you?\" so a great review can credit a specific server. On the Guest Reviews page (managers/owners), the \"Ask guests who took care of them\" switch removes that question entirely for the whole account — handy for counter-service spots, or if you'd rather not tie reviews to a person. Turn it off and the survey is just the rating and comment." },
      { kind: "tip", text: "Want to keep the question but hide one person (a back-office manager, catering, marketing)? Leave the switch on and, in Staff → their profile, turn off \"Show on the guest survey\" instead." },
      ...
      { kind: "h", text: "Turn a review into a shout-out" },
      { kind: "p", text: "When a response names a server, managers see a \"Recognize [name]\" button under that review. One tap posts it to the Culture Wins feed as a shout-out for that teammate — carrying the guest's own words — so real guest praise becomes team recognition without retyping it. Once posted the button reads \"Recognized on the Wins feed,\" and tapping it again won't double-post." },
      { kind: "h", text: "The AI readout" },
      { kind: "p", text: "At the top of the Reviews page, tap \"Summarize with AI\" and Wingman reads your recent feedback and hands back three things: what guests love, where to improve, and the single highest-leverage fix to make this week — grounded in your Owner's Mindset. It's ONE combined read across both your survey feedback and your Google reviews (when connected), so you get the full picture in one place instead of checking two tabs. It respects the location filter, so you can read one store or all of them." },
      { kind: "p", text: "Want it to come to you automatically? Under that readout, set \"Email this report automatically\" to Weekly or Monthly. Wingman then emails each location's report to that location's managers and you — every Monday, or on the 1st — so you get the pulse without having to open the app. Set it to Off to stop. Need it to also reach head office or a regional manager? Add one or more addresses in \"Also send to (master copy)\" and they'll get a copy of every location's report, on top of the location managers." },
      { kind: "h", text: "Ownership recap (owner only)" },
      { kind: "p", text: "Separate from the per-location report, the \"Ownership recap\" gives ownership one company-wide read across ALL locations, emailed to whichever addresses you choose. Set it to Daily (every morning) or Weekly (Mondays), enter the ownership email addresses, and Wingman sends a single combined recap — what guests love and where to improve across the whole company — with a few supporting direct quotes pulled straight from the feedback. This one is owner-controlled: only a Super Admin can see it, set the cadence, or edit who receives it." },
      { kind: "note", text: "Prefer just the highlights? Turn off \"Include the 'This week' action\" and the recap sticks to what guests love and where to improve, without the single action line — handy for an ownership group that only wants the pulse." },
      { kind: "tip", text: "Want to see it right now? Tap \"Send a test now\" in the Ownership recap card — Wingman emails a sample recap to your ownership addresses (or to you if you haven't saved any yet) so you can check the format before it goes out on schedule." },
      ...
      { kind: "p", text: "The Reviews page has two tabs at the top: Survey feedback (your own QR/link responses) and Google reviews. Switch to the Google reviews tab to connect your Google Business Profile — Wingman then pulls each location's Google reviews and reads them for you: overall rating and trend, what guests consistently love, where you're slipping (the recurring complaints), the themes, and a few concrete actions to raise your rating. It refreshes automatically every week, and you can hit Refresh anytime." },
      { kind: "list", items: [
  ...
  },
  {
    ...
    title: "Manager updates — your management team's back room",
    summary: "One org-wide channel for owners, managers, and shift leads to post updates and reply in threads. Staff never see it.",
    categoryId: "operations",
    keywords: ["manager updates", "manager channel", "managers", "messages", "chat", "threads", "back of house", "leadership", "manager chat"],
    body: [
      { kind: "p", text: "Manager updates is a single, org-wide channel just for your leadership — owners, managers, and shift leads. Post an update, flag an issue for the other shifts, ask a question, and reply in threads. It's the one place management talk lives, instead of scattered texts. Staff never see it." },
      { kind: "image", src: "/help/manager-channel.png", alt: "Manager updates with a thread", caption: "One org-wide channel for owners, managers, and shift leads — with threaded replies." },
      { kind: "steps", items: [
        "Open Manager updates (under More in the sidebar).",
      ...
      { kind: "note", text: "New-post emails are controlled by Settings → Notifications → \"Manager updates posts.\" In-app push to managers is always on." },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      { kind: "p", text: "Training & Standards holds a program for each role you run, split into hospitality behaviors and role-specific skills. The page is organized into tabs: Training by role, Tests & habits (assign tests and set up monthly refreshers), Menu, and your Sign-off log." },
      ...
      { kind: "note", text: "One place to manage it: open the \"Menu\" section near the top of Training & Standards to upload and edit your food and bar menus in one spot. The same menu still shows on each role's tab below (with a reminder that it's the shared list), so you can work from wherever you are — edits in one place show everywhere. This is the training menu; the numbers side (popularity, food cost, and the Stars/Dogs matrix) lives on the separate Menu Engineering screen under Growth." },
      ...
      { kind: "h", text: "Cost per plate → profit (no math)" },
      { kind: "p", text: "On each dish (managers/owners), enter its Popularity and its Plate cost — what the plate costs you to make. From the price you already have, Wingman does the math: it shows the profit in dollars and your food-cost % right there, and uses that profit to place the dish on the menu-engineering matrix (Stars / Puzzles / Plowhorses / Dogs) once you've costed a few. You enter the cost you actually know; Wingman handles the rest." },
      { kind: "tip", text: "This is a single cost-per-plate number, on purpose — enough to see which dishes make you money and which don't, without building a full ingredient-costing spreadsheet. Start with your best sellers; even a rough plate cost sorts the menu." },
      ...
      { kind: "p", text: "Don't want to type it all? On a dish with no recipe yet, tap \"Draft with AI\" — Wingman writes the steps from the dish's name and description as a starting point, then you review, fix anything the kitchen does differently, and add photos. It only drafts onto an empty recipe, so it never overwrites steps you've already written." },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "list", items: [
        ...
        "Hiring a corporate role that isn't at a restaurant (a marketing lead, a bookkeeper, a regional manager)? Pick \"Corporate (no location)\" instead of a store — there's nothing to choose. It's labeled \"Corporate\" on your careers page (not \"All locations\"), and applicants aren't asked which location they want, since there isn't one. Because there's no store email to route to, add a \"Send application alerts to\" address right on the opening and new applications for it go straight to that person (plus any account-wide copy addresses).",
      ] },
      ...
      { kind: "list", items: [
        "Built to stay short even with lots of openings: visitors get a search box and a role filter (plus a location filter if you run several stores), so the whole list fits on one screen and no location gets buried. Search matches the role name, type, and pay — so typing \"manager\" shows manager roles, not every ad that happens to mention one — and picking a role or location expands just the matches.",
      ...
      { kind: "list", items: [
        "Direct link to one role — each opening has its own public page (the role, the full description, and an Apply button). On the opening, tap \"Job page\" to copy that direct link and share it on its own — e.g. email it to a specific candidate or drop it in one job board. (That's different from the \"Apply link,\" which jumps straight into the application form.)",
        "Link to just one role on your careers page — running an ad for a specific role (say, managers)? In the \"Your public careers page\" bar, use \"Link to just one role\" to pick a role and copy a careers link that opens pre-filtered to only that role across all your locations. Great for a role-specific campaign, while the plain careers link still shows everything.",
        "Hide a role from your careers page — use \"Unlist\" on any opening to keep it OFF your public careers page and out of search, while its direct \"Job page\" link still works. Great for a confidential or one-off hire you only want to share with certain people. Tap \"List\" to put it back. You can also set this when creating or editing an opening with the \"Show on your public careers page\" checkbox.",
      ] },
      { kind: "note", text: "Every listed role also gets its own job page (with proper Google Jobs job-posting markup), and all of them are listed in Wingman's sitemap — so your openings can show up in Google's jobs search results, free applicant traffic most small restaurants never tap. Close a role and its page drops out of Google automatically. To speed up first indexing, an owner can submit the sitemap (joinwingman.app/sitemap.xml) once in Google Search Console — after that it's automatic." },
      { kind: "tip", text: "Give each location a complete address in Settings → Locations — including City, State, and ZIP. Google's job listings want those as separate fields, so filling them in makes your postings' location data complete (and clears the \"missing addressLocality/region/postalCode\" notices in Search Console). When you edit a location, Wingman pre-fills City/State/ZIP from the address you already had — just glance and save." },
      ...
      { kind: "list", items: [
        ...
        "Custom roles show up here too: once you post an opening for a custom role (e.g. Baker), it appears as its own tab (marked \"Custom\") so you can generate and save screening questions specifically for it — separately from every other role.",
      ...
      { kind: "h", text: "Ask about your applicants (AI)" },
      { kind: "p", text: "When applications pile up, open \"Ask about your applicants\" on the Hiring page and ask in plain English — like handing your whole applicant pile to an assistant and asking questions about it. You get a short answer plus a clickable shortlist of the matching people (with their screening tier, role, and contact info)." },
      { kind: "list", items: [
        "Filter: \"Who applied for line cook at Delray in the last two weeks and can work weekends?\"",
        "Shortlist: \"Top 5 to interview first, and why.\"",
        "Themes: \"What do my strongest applicants have in common?\" or \"Which source is sending better-fit candidates?\"",
        "It reads their form answers, screening answers, AI grades, and resume text — and only uses what applicants actually submitted, so it never invents people or experience.",
      ] },
      { kind: "note", text: "It looks at your active pipeline (everyone not already hired or rejected), scoped to the locations you manage. Resume search kicks in as uploaded resumes are processed in the background — usually within the hour of an application coming in." },
      { kind: "h", text: "Applications → Interview → Candidate" },
      { kind: "p", text: "The Hiring page is organized into tabs at the top: Applications, Interviews, Candidates, Job openings, and Setup (interview criteria, screening questions, reply/invite emails). Interviews and Candidates are their own tabs so they're one tap away even when you have a big pile of applications. The flow moves in one direction:" },
      ...
      { kind: "p", text: "Expand any applicant and you'll find a \"Reply to applicant\" box with two ready-to-send emails, so people who apply actually hear back — a small courtesy that protects your reputation and keeps good candidates warm." },
      { kind: "list", items: [
        "\"We're interested\" — a warm note letting them know you received their application and will be reaching out soon. Sending it marks them Reviewed.",
        "\"Not a fit\" — a gracious \"thank you, but not a good fit at the moment\" note that invites them to apply again down the road. Sending it moves them to the Rejected (Archived) tab.",
        "The email is sent from your restaurant's name, and any reply the applicant writes back goes to your location's email address on file (or your notification copy list if that location has no email set) — never to Wingman.",
      ...
      { kind: "p", text: "Want the wording to sound more like you? Open the \"Applicant reply emails\" section under the Setup tab on the Hiring page to edit both emails — subject and message. Use {{first_name}}, {{restaurant}}, and {{role}} anywhere and they fill in automatically; leave a field blank to fall back to the default, or hit \"Reset to default\" any time. Hit \"Send test to me\" to get a copy of exactly what an applicant receives (with sample details filled in) at your own email before you send it for real." },
  ...
  {
    slug: "standout-audit",
    title: "The Experience Audit",
    summary: "Score your operation and find the single most important thing to fix first.",
    categoryId: "operations",
    keywords: ["audit", "experience audit", "standout", "health score", "gaps", "constraint"],
    body: [
      { kind: "p", text: "The Experience Audit scores your operation across the five gaps and key domains, then gives you a Health Score and the one constraint to fix first." },
      { kind: "image", src: "/help/standout-audit.png", alt: "The Experience Audit screen", caption: "The Experience Audit — score your operation and get your Health Score." },
      { kind: "steps", items: [
        "Open Experience Audit (under More in the sidebar).",
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "list", items: [
        ...
        "Health score over time — your Experience Audit score audit-to-audit, plus checklist-compliance by month, so you can see whether the operation is genuinely getting stronger.",
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "list", items: [
        "Contact — name, email, phone, role(s), location, and active/inactive status.",
      ...
      { kind: "h", text: "One person, more than one role" },
      { kind: "p", text: "Some people work more than one job — a Host who also servers, a Server who jumps behind the bar. On the Contact tab, set their Primary role, then tap any Additional roles they cover. They'll get the training, menu, tests, and role checklists for every role they hold — and on their own pages they can flip between their role guides. Add or change roles anytime; it takes effect right away." },
      { kind: "note", text: "You can also set additional roles the moment you add someone: the \"Add staff member\" form has an Additional roles picker under the main role." },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "note", text: "SevenRooms note: SevenRooms is a reservation & guest-CRM platform, so it's an especially good source — it syncs your reservation guest profiles straight into Guests (new ones only, deduped by email/phone). Once it's live, enable Wingman as a partner integration in SevenRooms and paste your Venue ID into the SevenRooms card (multi-venue operators add each venue). Name your Wingman locations to match your SevenRooms venue names so guests land on the right store." },
      { kind: "list", items: [
      ...
      { kind: "note", text: "More platforms are being added as direct connections — Global Payments (Genius POS), Clover, Toast, Lightspeed, Heartland Retail, and SevenRooms (reservations) — and appear in the same Direct integrations list, with per-location data wherever your store names line up." },
