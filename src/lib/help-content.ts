...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "note", text: "Every open role also gets its own job page (with proper Google Jobs job-posting markup), and all of them are listed in Wingman's sitemap — so your openings can show up in Google's jobs search results, free applicant traffic most small restaurants never tap. Close a role and its page drops out of Google automatically. To speed up first indexing, an owner can submit the sitemap (joinwingman.app/sitemap.xml) once in Google Search Console — after that it's automatic." },
