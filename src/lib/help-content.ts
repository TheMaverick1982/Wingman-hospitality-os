...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "Share your application link" },
      { kind: "list", items: [
        "On the Hiring page, click \"Copy application link\" — it's a page on Wingman with your restaurant's name (and logo, once you add one), so there's nothing to build.",
        "Post it wherever you hire — Instagram bio, a QR code on the door, a job post, a text.",
        "You can pre-fill a role and location by adding them to the link, so an \"Apply for Server\" button lands already set.",
      ] },
      { kind: "h", text: "What the applicant fills in" },
      { kind: "p", text: "Name, contact, the role and location they want, availability, when they could come in, an optional note, and an optional resume. When they submit, the email on file for that location gets notified right away." },
      { kind: "h", text: "The Applicants tracker" },
      { kind: "list", items: [
        "Every application shows up under Hiring → Applicants with a status: New, Contacted, Not a fit, or Hired.",
        "Set or confirm a day/time for them to come in.",
        "Open their resume if they attached one.",
        "Filter by status to work your pipeline.",
      ] },
      { kind: "note", text: "Applicants don't get a login — they're just people who applied. When you're ready to interview, you'll turn an applicant into a scored candidate (pre-filled with their role and location) from the same place." },
    ],
