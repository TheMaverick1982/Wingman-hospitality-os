...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "p", text: "The Hiring page is organized into tabs: Applicants (your pipeline — applications, interviews, candidates), Job openings, and Setup (interview criteria, screening questions, reply/invite emails). Applications live under the Applicants tab, alongside your candidates. The flow moves in one direction:" },
