...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "It buzzes the team's phones" },
      { kind: "p", text: "When anyone posts a win or a shout-out — including a guest review a manager turns into a shout-out — everyone on the team who has the Wingman app installed gets a phone notification, so recognition is felt in the moment instead of scrolled past later. Setting this week's pre-shift focus or weekly experiment notifies the team the same way, so everyone starts the week pointed at the same thing." },
      { kind: "note", text: "Don't want the whole team buzzed for these? An owner can turn \"Wins & recognition\" or \"Weekly focus & experiment\" push off under Settings → Notifications (Culture). Only people who've installed the app and allowed notifications ever get them." },
