...
export const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "p", text: "Great hospitality is a habit, not a one-time program. Any learn-then-quiz test can be set to recur: open it and tick \"Continuing education — re-assign this to staff as a fresh attempt on the 1st of every month.\" On the 1st, Wingman automatically re-assigns it to the roles it targets as a brand-new attempt and emails each person a link — with the same reminders, deadlines, and results tracking as any other test. Build a short \"day one\" refresher once and it goes out every month on its own." },
