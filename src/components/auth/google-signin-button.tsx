...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2.5 rounded-[10px] px-[22px] py-[11px] text-[15px] font-semibold border border-line-strong bg-panel text-ink hover:bg-paper transition-colors"
    >
