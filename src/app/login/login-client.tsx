...
// `nativeIOS` is resolved on the server (page.tsx) from the app's user-agent
// token. Inside the iOS app we hide account-creation paths (signup, demo) and
// the "Continue with Google" third-party login, leaving email/password sign-in
// only — this is what satisfies App Review guidelines 3.1.1 and 4.8. The web
// login is unchanged.
export function LoginClient({ nativeIOS = false }: { nativeIOS?: boolean }) {
