...
export const metadata: Metadata = {
  ...
  description:
    "See how small gains across three channels — returning guests, average check, and new guests — compound into a big annual revenue lift. A live planner, plus the Wingman systems that move each lever.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Nudge three channels a few percent each and watch revenue compound — then see the systems that make it happen.",
...
const config: FeatureLandingConfig = {
  ...
  steps: [
    { title: "Returning guests → guest retention", body: "Turning more first-timers into regulars — and getting them back more often — is the highest-leverage channel you have, because you already paid to get them in the door. Wingman tracks every first-timer and gives your team the habits to bring them back." },
    ...
    { title: "They compound, not just add", body: "Because these levers feed the same revenue, a 5% gain in three places isn't a 15% lift — it's more. That's the whole point: modest, achievable gains that multiply into a number that changes your year." },
    { title: "One system moves all three", body: "The reason most plans stall is that separate tools (or none) can't move these levers together. Wingman runs culture, training, retention, and reviews in one place, so the whole plan actually happens." },
  ],
  stats: [
    { value: "3 channels", label: "Returning guests, average check, and new guests — moved together." },
  ...
  faqs: [
    ...
    { q: "Why do small percentages turn into such a big number?", a: "Because the levers multiply rather than add. If three channels each improve 5%, you don't get +15% — you get roughly 1.05³, and on a business doing seven figures that difference is enormous. Compounding is the entire strategy." },
    { q: "Which lever should I focus on first?", a: "Usually returning guests — you've already paid to acquire those people, so bringing more of them back is the cheapest growth you'll ever buy. But the power is in nudging all three together, which is exactly what Wingman is built to do." },
    { q: "How does Wingman actually move these numbers?", a: "Each channel maps to a Wingman system: retention tracking for returning guests, role-based training for average check, and review management for new-guest traffic — all run from one place so the plan happens every shift, not just on paper." },
