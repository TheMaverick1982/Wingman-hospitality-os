  ...
  return (
    <form action={formAction}>
      <textarea
        ...
        rows={2}
        className="w-full rounded-lg p-3 text-sm bg-panel border border-[#ffcc80] text-ink"
      />
      <div className="flex items-center justify-between mt-2">
        <p className="text-xs text-[#b45309]">Read this at the start of every shift, every location, this week.</p>
