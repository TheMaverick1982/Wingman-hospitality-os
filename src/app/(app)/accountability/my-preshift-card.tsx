    ...
    return (
      <div className="bg-white border border-line rounded-2xl p-6 shadow-sm">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-[15px] font-semibold text-ink">{tr("checklist.preshift.done")}</div>
  ...
  return (
    <div className="bg-white border border-line rounded-2xl p-6 shadow-sm">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h3 className="text-[15px] font-semibold text-ink">{tr("checklist.preshift.title")}</h3>
      </div>
      <p className="text-[13px] text-muted mb-4">{tr("checklist.preshift.sub")}</p>
      <form action={formAction}>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Btn type="submit" disabled={pending}>
            {pending ? tr("checklist.submitting") : tr("checklist.submit")}
          </Btn>
        </div>
      </form>
    </div>
