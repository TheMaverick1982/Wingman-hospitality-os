    ...
    return (
      <div className="bg-white border border-line rounded-2xl p-6 shadow-sm">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-[15px] font-semibold text-ink">{tr("checklist.loyalty.done")}</div>
  ...
  return (
    <div className="bg-white border border-line rounded-2xl p-6 shadow-sm">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h3 className="text-[15px] font-semibold text-ink">{tr("checklist.loyalty.title")}</h3>
      </div>
      <p className="text-[13px] text-muted mb-4">{tr("checklist.loyalty.sub")}</p>
